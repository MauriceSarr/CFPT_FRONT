<template>
        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Accueil</a>&nbsp;<i
   ...
   <!--      <div class="row">
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            <div class="btn-group">
                                                <button class="btn btn-xs btn-info dropdown-toggle no-margin" type="button"
        ...
        <div class="row" >
            ...
            <div class="col-md-4 col-sm-12 col-12">
                <div class="white-box border-gray">
                    <h4 class="box-title"><small class="pull-right m-t-10 text-danger"><i class="fa fa-sort-desc"></i>
                            30% Low then
  ...
  highlightSpotColor: "#4f4f4f",
    ...
    methods: {
        ...
        async fetchUtilisateurs() {
            ...
            await axios.get('/user/index', {headers})
                .then(response => {
