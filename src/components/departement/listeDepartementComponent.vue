                            ...
                            <div class="tabbable-line">
                                ...
                                <ul class="nav customtab nav-tabs" role="tablist">
                                    <li class="nav-item"><a href="#tab1" class="nav-link active"
                                            data-bs-toggle="tab">Département</a>
                                    </li>
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                <tr class="odd gradeX"
                                                                    ...
                                                                    <td> {{ departement.user_prenom }} {{
                                                                        departement.user_nom }}</td>
                            ...
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li><a class="parent-item"
                                            href="{{ route('departement_create') }}">Département</a>&nbsp;<i
                                            class="fa fa-angle-right"></i>
                                    </li>
                                    <li class="active">Modifier Département</li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
    ...
    methods: {
        ...
        async get_departement() {
            ...
            await axios.get('/departement/all', {headers})
                .then(response => {
                    const alldepartement = response.data.departement
                    const formattedDepartement = alldepartement.map(depart => {
                        return {
                            id: depart.id,
        ...
        async deleteDepartement(type) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    axios.delete(`/departement/delete/${type.id}`, {headers}).then(resp => {
