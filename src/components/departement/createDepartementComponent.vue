                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Nouveau Département</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Paramétres &nbsp;<a class="parent-item"></a>&nbsp;<i
                                        class="fa fa-angle-right"></i>
                                <li><a class="parent-item" :href="'/departement/create'">Département</a>&nbsp;<i
                                        class="fa fa-angle-right"></i>
                                </li>
                                    </li>
                                </li>
                                ...
                                <div class="card-body row">
                                    <div class="col-lg-6 p-t-20">
                                        <div
                                            ...
                                            <label class="mdl-textfield__label" for="txtFirstName" v-show="!form.nom">Nom
                                                Département</label>
                                            <input class="mdl-textfield__input" type="text" id="txtFirstName"
                                                v-model="form.nom" @input="validatedata('nom_departement')">
                                    ...
                                    <div class="col-lg-6 p-t-20 mt-1">
                                        <div
                                            ...
                                            <label class="mdl-textfield__label" for="directionSelect"
                                                v-show="!form.id_direction"> Choisissez la direction
                                            </label>
                                    ...
                                    <div class="col-lg-6 p-t-20">
                                        <div
                                            ...
                                            <label for="list6" class="mdl-textfield__label"
                                                v-show="!form.id_user">Choisissez le chef de département</label>
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    <tr class="odd gradeX" v-for="(departement, index) in departements"
                                                        ...
                                                        <td
                                                            v-show="departement.user.prenom != '' && departement.user.nom != ''">
                                                            {{ departement.user.prenom }} {{ departement.user.nom }}</td>
  ...
  components: {
    ...
    methods: {
        ...
        async soumettre() {
            ...
            try {
                await axios.post('/departement/store', formdata, {headers});
        ...
        async get_departement() {
            const token = localStorage.getItem("token");
            const headers = { Authorization: `Bearer ${token}` };
            await axios.get('/departement/get/last', {headers})
                .then(response => {
        ...
        async update_departement(id) {
            ...
            try {
                await axios.post('/departement/update/' + id, formdata, {headers});
