                        ...
                        <div class="col-md-12">
                            <div class="tabbable-line">
                                ...
                                <ul class="nav customtab nav-tabs" role="tablist">
                                    <li class="nav-item"><a href="#tab1" class="nav-link active" data-bs-toggle="tab">Type
                                            Formation</a>
                                    </li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card card-box">
                                                    <div class="card-head">
                                                        <header>Tous les types de formation</header>
                                                        <div class="tools">
                                                            ...
                                                            <tbody>
                                                                <tr class="odd gradeX"
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a class="tblDelBtn"
                                                                            @click="deleteTypeFormation(formation)">
                            ...
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li><a class="parent-item"
                                            href="{{ route('type_formation_create') }}">Service</a>&nbsp;<i
                                            class="fa fa-angle-right"></i>
                                    </li>
                                    <li class="active">Modifier Type de Formation</li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
    ...
    methods: {
        ...
        async deleteTypeFormation(type) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    axios.delete(`/type_formation/delete/${type.id}`, {headers}).then(resp => {
