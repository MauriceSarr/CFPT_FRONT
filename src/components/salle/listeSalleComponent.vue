                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" :href="'/service/accueil'"> Salle</a>&nbsp;<i
                                                ...
                                                <div class="card card-box">
                                                    ...
                                                    <div class="card-body ">
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                <tr class="odd gradeX" v-for="(salle, index) in salles"
                                                                    :key="index">
                                                                    <td> {{ index + 1 }} </td>
                                                                    <td> {{ salle.salle }} </td>
                                                                    <td> {{ salle.nombre_de_place }}</td>
                                                                    <td> {{ salle.batiment }} </td>

                                                                    <td>
                                                                        <a class="tblEditBtn" @click="openModal(salle)">
                                                                            <i class="fa fa-pencil"></i>
                                                                        </a>
                                                                        <a class="tblDelBtn" @click="deleteSalle(salle)">
                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li class="active">Modifier Salle</li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
...
import FormulaireModification from './createSalleComponent.vue';
...
export default {
  components: {
    ...
    mounted() {
        ...
        bus.on('salleDejaModifier', (eventData) => {
    ...
    methods: {
        ...
        async deleteSalle(type) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    axios.delete(`/salle/delete/${type.id}`, {headers}).then(resp => {
