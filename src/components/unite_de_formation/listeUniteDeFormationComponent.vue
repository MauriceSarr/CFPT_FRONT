                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                <tr class="odd gradeX"
                                                                    ...
                                                                    <td>
                                                                        <a class="tblEditBtn"
                                                                            @click="openModal(unite_de_formation)">
                            ...
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li><a class="parent-item"
                                            href="{{ route('unite_deformation_create') }}">Filière</a>&nbsp;<i
                                            class="fa fa-angle-right"></i>
                                    </li>
    ...
    methods: {
        ...
        async deleteUniteDeFormation(type) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    axios.delete(`/unite_de_formation/delete/${type.id}`, {headers}).then(resp => {
