<template>
  <div class="page-logo">
    <a href="{{ route('admin_index') }}">
      ...
      <span class="logo-default">CFPT-Digital</span>
    </a>
  </div>
  <!-- logo end -->
  ...
  <div class="top-menu">
    <ul class="nav navbar-nav pull-right">
      <li>
        <a class="fullscreen-btn"><i data-feather="maximize"></i></a>
      </li>
      <!-- start language menu -->
      ...
      <li class="dropdown dropdown-user">
          <a class="dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown"
                data-close-others="true">
                <img :alt="getImageUrl(this.userPhoto)" class="img-circle" :src="getImageUrl(this.userPhoto)" />
                <span class="username username-hide-on-mobile"> {{this.userNom}} {{ this.userPrenom }} </span>
            </a>
        <ul class="dropdown-menu dropdown-menu-default">
          <li>
            <a href="/utilisateur/profil"> <i class="icon-user"></i> Profil </a>
          </li>
...
export default {
  props: ['userNom', 'userPhoto', 'userPrenom'], 
