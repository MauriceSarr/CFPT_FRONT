                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" href="{{ route('eleve_inscription') }}">Inscription </a>&nbsp;<i
                                        class="fa fa-angle-right"></i>
                                </li>
                            </li>
                            ...
                            <div class="card-box">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <label class="mdl-textfield__label" for="txtFirstName"
                                            v-show="!form.nom_eleve">Nom</label>
                                        <input class="mdl-textfield__input" type="text" id="txtFirstName"
                                            v-model="form.nom_eleve" @input="validatedata('nom_eleve')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    ...
                                    <div
                                        ...
                                        <label class="mdl-textfield__label" for="txtLastName"
                                            v-show="!form.prenom_eleve">Prénom</label>
                                        <input class="mdl-textfield__input" type="text" id="txtLastName"
                                            v-model="form.prenom_eleve" @input="validatedata('prenom_eleve')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <label class="mdl-textfield__label" for="dateOfBirth"
                                            v-show="!form.date_naissance_eleve">Date de
                                            Naissance</label>
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <label class="mdl-textfield__label" for="designation"
                                            v-show="!form.lieu_naissance_eleve">Lieu de
                                            naissance</label>
                                        <input class="mdl-textfield__input" type="text" id="designation"
                                            v-model="form.lieu_naissance_eleve" @input="validatedata('naissance')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    ...
                                    <div
                                        ...
                                        <label class="mdl-textfield__label" for="list2"
                                            v-show="!form.nationalite_eleve">Nationalité</label>
                                        <input class="mdl-textfield__input" type="text" id="list2"
                                            v-model="form.nationalite_eleve" @input="validatedata('nationalite_eleve')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    ...
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label class="mdl-textfield__label" for="list2"
                                            v-show="!form.adresse_eleve">Adresse</label>

                                        <input class="mdl-textfield__input" type="text" id="list2"
                                            v-model="form.adresse_eleve" @input="validatedata('adresse_eleve')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <label for="list3" class="mdl-textfield__label"
                                            v-show="!form.genre_eleve">Choisissez Genre</label>
                                        <select class="mdl-textfield__input" id="list3" readonly tabIndex="-1"
                                            v-model="form.genre_eleve" @change="validatedata('genre_eleve')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <label class="mdl-textfield__label" for="text5"
                                            v-show="!form.telephone_eleve">Téléphone</label>
                                        <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?"
                                            id="text5" v-model="form.telephone_eleve"
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <label class="mdl-textfield__label" for="designation2"
                                            v-show="!form.mail_eleve">E-mail</label>
                                        <input class="mdl-textfield__input" type="text" id="designation2"
                                            v-model="form.mail_eleve" @input="validatedata('mail_eleve')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label class="mdl-textfield__label" for="text5"
                                            v-show="!form.contact_urgence1">Contact Urgence 1</label>
                                        <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?"
                                            id="text5" v-model="form.contact_urgence1"
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label class="mdl-textfield__label" for="text5"
                                            v-show="!form.contact_urgence2">Contact Urgence 2</label>
                                        <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?"
                                            id="text5" v-model="form.contact_urgence2"
                            ...
                            <i class="material-icons">more_vert</i>
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label class="mdl-textfield__label" for="txtFirstName"
                                            v-show="!form.nom_tuteur">Nom</label>
                                        <input class="mdl-textfield__input" type="text" id="txtFirstName"
                                            v-model="form.nom_tuteur" @input="validatedata('nom_tuteur')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    ...
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label class="mdl-textfield__label" for="txtLastName"
                                            v-show="!form.prenom_tuteur">Prénom</label>
                                        <input class="mdl-textfield__input" type="text" id="txtLastName"
                                            v-model="form.prenom_tuteur" @input="validatedata('prenom_tuteur')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label class="mdl-textfield__label" for="text5"
                                            v-show="!form.telephone_tuteur">Téléphone</label>
                                        <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?"
                                            id="text5" v-model="form.telephone_tuteur"
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label class="mdl-textfield__label" for="designation2"
                                            v-show="!form.mail_tuteur">E-mail</label>
                                        <input class="mdl-textfield__input" type="text" id="designation2"
                                            v-model="form.mail_tuteur" @input="validatedata('mail_tuteur')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label class="mdl-textfield__label" for="dateOfBirth"
                                            v-show="!form.date_naissance_tuteur">Date de
                                            Naissance</label>
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label class="mdl-textfield__label" for="designation"
                                            v-show="!form.lieu_naissance_tuteur">Lieu de
                                            naissance</label>
                                        <input class="mdl-textfield__input" type="text" id="designation"
                                            v-model="form.lieu_naissance_tuteur" @input="validatedata('naissance')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    ...
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label class="mdl-textfield__label" for="list2"
                                            v-show="!form.nationalite_tuteur">Nationalité</label>
                                        <input class="mdl-textfield__input" type="text" id="list2"
                                            v-model="form.nationalite_tuteur" @input="validatedata('nationalite_tuteur')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    ...
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <label class="mdl-textfield__label" for="list2"
                                            v-show="!form.adresse_tuteur">Adresse</label>

                                        <input class="mdl-textfield__input" type="text" id="list2"
                                            v-model="form.adresse_tuteur" @input="validatedata('adresse_tuteur')">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                        <label for="list3" class="mdl-textfield__label"
                                            v-show="!form.genre_tuteur">Choisissez Genre</label>
                                        <select class="mdl-textfield__input" id="list3" readonly tabIndex="-1"
                                            v-model="form.genre_tuteur" @change="validatedata('genre_tuteur')">
                                            <option value="Masculin">Masculin</option>
                                            <option value="Féminin">Féminin</option>
                                        </select>
                            ...
                            <i class="material-icons">more_vert</i>
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <label for="list7" class="mdl-textfield__label"
                                            v-show="!form.id_annee_accademique">Année
                                            Académique</label>
                                        <select class="mdl-textfield__input" id="list7" readonly tabIndex="-1"
                                            ...
                                            <option v-for="(annee_accademique, index) in annee_accademiques"
                                                :value="annee_accademique.id" :key="index">
                                                {{
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <select class="mdl-textfield__input" id="list9" readonly tabIndex="-1"
                                            v-model="form.id_departement" @change="get_filiere(form.id_departement)">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <label for="list99" class="mdl-textfield__label"
                                            v-show="!form.id_filiere">Choisissez Filière</label>
                                        <select class="mdl-textfield__input" id="list99" readonly tabIndex="-1"
                                            v-model="form.id_filiere" @change="get_classe(form.id_filiere)">
                                            <option v-for="(filiere, index) in filieres" :value="filiere.id" :key="index">{{
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <label for="list99" class="mdl-textfield__label" v-show="!form.id_classe">Choisissez
                                            Classe</label>
                                        <select class="mdl-textfield__input" id="list99" readonly tabIndex="-1"
                                            v-model="form.id_classe" @change="validatedata('id_classe')">
  ...
  components: {
    ...
    methods: {
        ...
        async get_annee() {
            const token = localStorage.getItem("token");
            const headers = { Authorization: `Bearer ${token}` };
            await axios.get('/annee_academique/index', {headers}).then(response => {
        ...
        async get_classe(id) {
            const token = localStorage.getItem("token");
            const headers = { Authorization: `Bearer ${token}` };
            await axios.get('/find/classes/' + id, {}, {headers}).then(response => {
        ...
        async get_departement() {
            const token = localStorage.getItem("token");
            const headers = { Authorization: `Bearer ${token}` };
            await axios.get('/departement/all', {headers}).then(response => {
        ...
        async get_filiere(id) {
            const token = localStorage.getItem("token");
            const headers = { Authorization: `Bearer ${token}` };
            await axios.get('/find/filieres/' + id, {}, {headers}).then(response => {
        ...
        async update_utilisateur(id) {
            ...
            try {
                const user_store = await axios.post('/inscription/update/' + id, formdata, {headers});
                bus.emit('inscriptionAjoutee');
