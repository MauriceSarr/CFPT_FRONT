                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" :href="'/eleve/create'">Inscription</a>&nbsp;<i
                            ...
                            <div class="tabbable-line">
                                ...
                                <ul class="nav customtab nav-tabs" role="tablist">
                                    <li class="nav-item"><a href="#tab1" class="nav-link active"
                                            data-bs-toggle="tab">Inscription
                                            Non Payée</a>
                                    </li>
                                    <li class="nav-item"><a href="#tab2" class="nav-link" data-bs-toggle="tab">Inscription
                                            Payée</a>
                                    </li>
                                                    ...
                                                    <div class="card-body ">
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6 col-6">
                                                                <div class="btn-group">
                                                                    <a :href="'/eleve/inscription'" id="addRow"
                                                            ...
                                                            <tbody>
                                                                <tr class="odd gradeX"
                                                                    ...
                                                                    <td class="patient-img"> <img
                                                                            :src="getImageUrl(inscription.photo)" alt="Etu">
                                                                    </td>
                                                                    <td> {{ inscription.matricule }}</td>
                                                                    <td class="left"> {{ inscription.nom }}</td>
                                                                    <td class="left"> {{ inscription.prenom }}</td>
                                                                    <td class="left">{{ inscription.date }} {{
                                                                        inscription.lieu_naissance_eleve }}</td>
                                                                    <td class="left">{{ inscription.classe
                                                                    }} </td>
            ...
            <div class="page-content-wrapper" v-show="editModal">
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Nouvelle Inscription</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                                ...
                                <li><a class="parent-item" href="{{ route('inscription_eleve') }}">Inscrire
...
import FormulaireModification from './inscriptionComponent.vue';
...
export default {
  components: {
    ...
    methods: {
        ...
        async get_inscription() {
            const token = localStorage.getItem("token");
            const headers = { Authorization: `Bearer ${token}` };
            await axios.get('/inscription/all', {headers})
                .then(response => {
        ...
        async deleteInscription(type) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    axios.delete(`/inscription/delete/${type.id}`, {headers}).then(resp => {
