							...
							<div class="card-body no-padding height-9">
								<div class="row">
									<div class="profile-userpic">
										<img :src="getImageUrl(this.authphoto)" class="img-responsive" alt="">
									</div>
								</div>
								<div class="profile-usertitle">
									<div class="profile-usertitle-name">{{ this.authprenom }} {{ this.authnom }}</div>
									<div class="profile-usertitle-job"> {{ this.authrole }} </div>
									<div class="profile-usertitle-job"> {{ this.authmatricule }} </div>
								</div>
								...
								<div class="profile-userbuttons">
									<button type="button"
										class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary">  <i class="fa fa-envelope"></i> Messagerie </button>
									<button type="button"
								...
								<!-- END SIDEBAR BUTTONS -->
							</div><!-- btn btn-circle btn-info fa fa-cogs -->
						</div>
						<div class="card">
							<div class="card-head">
							...
							<div class="card-body no-padding height-9">
								...
								<ul class="list-group list-group-unbordered">
									<li class="list-group-item">
										<b>Genre </b>
										<div class="profile-desc-item pull-right">{{ this.authgenre }}</div>
									</li>
									<li class="list-group-item">
										<b>Operation Done </b>
								...
								<div class="white-box">
									...
									<div class="p-rl-20">
										<ul class="nav customtab nav-tabs" role="tablist">
											<li class="nav-item"><a href="#tab1" class="nav-link active"
													data-bs-toggle="tab">Informations</a></li>
									...
									<div class="tab-content">
										<div class="tab-pane active fontawesome-demo" id="tab1">
											<div id="biography">
												<div class="row">
													<div class="col-md-3 col-6 b-r"> <strong>Nom Complet</strong>
														<br>
														<p class="text-muted">{{ this.authprenom }} {{ this.authnom }}</p>
													</div>

													<div class="col-md-3 col-6 b-r"> <strong>Mobile</strong>
														<br>
														<p class="text-muted">{{ this.authtelephone }}</p>
													</div>
												...
												<br>
												<h4 class="font-bold">Experience Professionnelle</h4>
												<hr>
												<ul>
...
export default {
	...
	methods: {
		...
		getServiceUtilisateurConnecte() {
			const token = localStorage.getItem('token');
            const headers = { Authorization: `Bearer ${token}` };
			axios.get('/utilisateur/service', {headers})
				.then(response => {
